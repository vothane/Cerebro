...
(deftest contrastive-divergence-test
  (testing "RBM contrastive divergence"
    (let [init-rbm (RBM [[0.14839871643137212 -0.08501163823540675 0.051985421731801734 -0.14855205346676653 -0.044137597789180485 -0.0701731889478024] 
                        ...
                        [0 0 0 0 0 0]
                        6)
          real-rbm (RBM [[0.14887447885553112 -0.08453587581124775 0.05246118415596073 -0.14855205346676653 -0.05247535492705986 -0.07851094608568178] 
                        ...
                        [0.008328909528787289 -0.008938006215604427 0.008299941456760423] 
                        [0.0 0.0 0.0 0.0 -0.016666666666666673 -0.016666666666666673]
                        6)]
                       ...
                       #'gibbs-hvh (fn [a b c d] 
                                         {:v|h {:means [0.5658630728981506 0.4599204997897266 0.5220720174294667 0.4425876572353885 0.5118512337012591 0.4425022458987821] 
                                          ...
                                          :h|v {:means [0.5002654282727627 0.5362803729362655 0.5020035125943747]
                                                :samples [0 1 0]}})}
        #(is (= (rbm->map (contrastive-divergence init-rbm [1 1 1 0 0 0] 0.1 1)) 
                (rbm->map real-rbm)))))))

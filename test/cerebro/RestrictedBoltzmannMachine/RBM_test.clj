...
(deftest contrastive-divergence-test
  (testing "RBM contrastive divergence"
    (let [init-rbm {:N 6
                    ...
                    :hbias [0 0 0] 
                    :vbias [0 0 0 0 0 0]}
          calc-rbm (RBM-contrastive-divergence init-rbm [1 1 1 0 0 0] 0.1 1)
          real-rbm {:N 6
                    ...
                    :hbias [0.008328909528787289 -0.008938006215604427 0.008299941456760421] 
                    :vbias [0.0 0.0 0.0 0.0 -0.016666666666666666 -0.016666666666666666]}]
      (is (= calc-rbm real-rbm)))))
